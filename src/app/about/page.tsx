        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-7 mb-3">
            ...
            <p className="text-justify">
              ...
              cherished adornment that celebrates a woman's identity and elegance. Every masterpiece
              we create tells a story of beauty, joy, and heritage. At Suvarnakala, we give utmost
              importance to design, detail, and innovation. Our ornaments are crafted with care,
              stringent quality control, and state-of-the-art technology, ensuring each piece
              resonates with elegance and authenticity.{' '}
            </p>
          </div>
