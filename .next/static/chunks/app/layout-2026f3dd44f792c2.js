(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [177],
  {
          ...
          children: [
            (0, s.jsxs)(r(), {
              children: [
                ...
                (0, s.jsx)('meta', { property: 'og:image', content: i.A.src }),
                  ...
                  children: [
                            ...
                            (0, s.jsxs)('div', {
                              ...
                              children: [
                                (0, s.jsx)('a', {
                                  ...
                                  children: (0, s.jsx)(n.feZ, { className: 'icon-small' }),
                                }),
                                (0, s.jsx)('a', {
                                  href: '#',
                                  className: 'text-red hover-social',
                                  'aria-label': 'Follow Suvarnakala on Facebook',
                                  children: (0, s.jsx)(n.iYk, { className: 'icon-small' }),
                                }),
                                (0, s.jsx)('a', {
                                  href: '#',
                                  className: 'text-red hover-social',
                                  'aria-label': 'Follow Suvarnakala on Instagram',
                                  children: (0, s.jsx)(n.ao$, { className: 'icon-small' }),
                                }),
                              ],
                            }),
                          ],
                    ...
                    (0, s.jsx)('div', {
                      ...
                      children: (0, s.jsxs)('p', {
                        ...
                        children: ['\xa9 ', A, ' suvarnakala. All Rights Reserved.'],
                      }),
                    }),
                  ],
                }),
        ...
        k = () => {
          let e = (0, d.usePathname)(),
            ...
            E = () => {
              let e = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz',
                a = '';
              for (let t = 0; t < 6; t++) a += e.charAt(Math.floor(Math.random() * e.length));
              M(a);
              let t = U.current;
              if (t) {
                ...
                if (e) {
                  ...
                  for (let a = 0; a < 50; a++)
                    (e.fillStyle = 'rgba(0, 0, 0, '.concat(0.2 * Math.random(), ')')),
                      e.fillRect(Math.random() * t.width, Math.random() * t.height, 2, 2);
                  (e.font = '20px Arial'),
                    (e.fillStyle = '#000'),
                    (e.textAlign = 'center'),
                    (e.textBaseline = 'middle');
                  let s = t.width / (a.length + 1);
          ...
          let G = (e) => {
            ...
            I = () => {
              let e = {};
              return (
                k.name.trim() || (e.name = 'Name is required'),
                k.email.trim()
                  ? /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(k.email) ||
                    (e.email = 'Please enter a valid email address')
                  : (e.email = 'Email is required'),
                k.mobile.trim()
                  ? /^[0-9]{10}$/.test(k.mobile) ||
                    (e.mobile = 'Please enter a valid 10-digit mobile number')
                  : (e.mobile = 'Mobile number is required'),
                k.city.trim() || (e.city = 'City is required'),
                k.store.trim() || (e.store = 'Store is required'),
                k.date || (e.date = 'Appointment date is required'),
                k.jewelry.trim() || (e.jewelry = 'Interested jewelry is required'),
                k.captchaAnswer.trim()
                  ? k.captchaAnswer.trim().toLowerCase() !== B.toLowerCase() &&
                    ...
                    (0, s.jsx)(m.A.Collapse, {
                      ...
                      children: (0, s.jsx)(h.A, {
                        ...
                        children: [
                          ...
                          let { href: r, label: o, onClick: i } = a,
                            c = !i && (e === r || e.startsWith(r + '/'));
                          return (0, s.jsx)(
                            n(),
                            {
                              href: r,
                              ...
                              onClick: (e) => {
                                i && (e.preventDefault(), i()), t(!1);
                              },
                              style: { textDecoration: 'none' },
                              children: (0, s.jsx)(h.A.Link, {
                                as: 'span',
                                className: c ? 'text-danger active-link' : 'text-dark',
                                children: o,
                              }),
                            },
                            l
                                ...
                                children: [
                                  ...
                                  (0, s.jsx)('div', {
                                    ...
                                    children: (0, s.jsxs)('div', {
                                      ...
                                      children: [
                                        (0, s.jsx)(j.Ay, {
                                          selected: k.date ? new Date(k.date) : null,
                                          onChange: (e) =>
                                            C((a) => ({
                                              ...a,
                                              date:
    ...
    25731: (e, a, t) => {
      'use strict';
      t.d(a, { Ay: () => i, C1: () => l, uu: () => o });
      var s = t(23464);
      let l = 'https://skalaapi.anaxistech.com',
        r = s.A.create({ baseURL: l, headers: { 'Content-Type': 'application/json' } }),
        o = async (e) => {
          try {
            return (await r.post('/api/sendappointment', e)).data;
          } catch (e) {
    ...
    74787: (e, a, t) => {
      Promise.resolve().then(t.t.bind(t, 15685, 23)),
        Promise.resolve().then(t.t.bind(t, 30347, 23)),
        Promise.resolve().then(t.bind(t, 6821)),
        Promise.resolve().then(t.bind(t, 25575));
    },
    95794: (e, a, t) => {
      'use strict';
      t.d(a, { A: () => s });
  ...
  (e) => {
    var a = (a) => e((e.s = a));
    e.O(0, [740, 278, 897, 711, 545, 579, 63, 62, 209, 9, 770, 255, 348, 441, 684, 358], () =>
      a(74787)
    ),
      (_N_E = e.O());
  },
