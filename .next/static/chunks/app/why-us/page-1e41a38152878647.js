(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [646],
  {
    4034: (e, t, a) => {
      ...
      var n = a(66766),
        ...
        s = a(60902);
      let o = {
        src: '/_next/static/media/why-choose.d5062353.jpg',
        height: 660,
        width: 1440,
        blurDataURL:
        ...
        m = () =>
          (0, l.jsxs)(l.Fragment, {
            children: [
              ...
              (0, l.jsx)('div', {
                style: { backgroundColor: '#F5E7D6', padding: '40px 0' },
                children: (0, l.jsxs)(r.default, {
                  ...
                  children: [
                    (0, l.jsx)('div', {
                      className:
                        'custom-heading-wrapper text-center justify-content-center d-flex align-items-center mb-4',
                      children: (0, l.jsx)('h2', {
    ...
    11846: (e, t, a) => {
      ...
      let s = r.forwardRef((e, t) => {
        let { bsPrefix: a, className: l, as: r = 'div', ...s } = e,
          o = (0, i.oU)(a, 'row'),
          d = (0, i.gy)(),
          c = (0, i.Jm)(),
          u = ''.concat(o, '-cols'),
        ...
        return (
          ...
          (0, A.jsx)(r, { ref: t, ...s, className: n()(l, o, ...g) })
        );
      });
      s.displayName = 'Row';
      let o = s;
    ...
    32960: (e, t, a) => {
      ...
      function i({
        ...
        e || (e = null != a || null != l || null != n ? 'a' : 'button');
        let o = { tagName: e };
        if ('button' === e) return [{ type: s || 'button', disabled: t }, o];
        let d = (l) => {
          var n;
          if (((!t && ('a' !== e || ((n = a) && '#' !== n.trim()))) || l.preventDefault(), t))
            return void l.stopPropagation();
          null == i || i(l);
        };
        return (
          'a' === e && (a || (a = '#'), t && (a = void 0)),
      ...
      let A = l.forwardRef((e, t) => {
        let { as: a, disabled: l } = e,
          ...
          [s, { tagName: o }] = i(Object.assign({ tagName: a, disabled: l }, A));
        return (0, n.jsx)(o, Object.assign({}, A, s, { ref: t }));
      });
    ...
    60902: (e, t, a) => {
      ...
      let o = r.forwardRef((e, t) => {
        let {
          ...
          h = (0, A.oU)(l, 'btn'),
          [f, { tagName: p }] = (0, i.Am)({ tagName: a, disabled: c, ...g });
        return (0, s.jsx)(p, {
          ...f,
          ...g,
          ref: t,
    ...
    68136: (e, t, a) => {
      ...
      var l = a(29300),
        ...
        A = a(95155);
      let s = r.forwardRef((e, t) => {
        let [{ className: a, ...l }, { as: r = 'div', bsPrefix: s, spans: o }] = (function (e) {
          let { as: t, bsPrefix: a, className: l, ...r } = e;
          a = (0, i.oU)(a, 'col');
          let A = (0, i.gy)(),
            s = (0, i.Jm)(),
            o = [],
            ...
            A.forEach((e) => {
              ...
              delete r[e],
                'object' == typeof i && null != i
                  ? ({ span: t, offset: l, order: n } = i)
                  : (t = i);
              let A = e !== s ? '-'.concat(e) : '';
              t &&
                o.push(!0 === t ? ''.concat(a).concat(A) : ''.concat(a).concat(A, '-').concat(t)),
                null != n && d.push('order'.concat(A, '-').concat(n)),
                null != l && d.push('offset'.concat(A, '-').concat(l));
            }),
            [
              { ...r, className: n()(l, ...o, ...d) },
              { as: t, bsPrefix: a, spans: o },
            ]
          );
        })(e);
        return (0, A.jsx)(r, { ...l, ref: t, className: n()(a, !o.length && s) });
      });
      s.displayName = 'Col';
      let o = s;
    },
    ...
    92402: (e, t, a) => {
      Promise.resolve().then(a.bind(a, 4034));
    },
    92809: (e, t, a) => {
      'use strict';
      a.d(t, { default: () => o });
      var l = a(29300),
        ...
        A = a(95155);
      let s = r.forwardRef((e, t) => {
        let { bsPrefix: a, fluid: l = !1, as: r = 'div', className: s, ...o } = e,
          d = (0, i.oU)(a, 'container');
        return (0, A.jsx)(r, {
          ref: t,
          ...o,
          className: n()(
            s,
            l ? ''.concat(d).concat('string' == typeof l ? '-'.concat(l) : '-fluid') : d
          ),
        });
      });
  ...
  (e) => {
    var t = (t) => e((e.s = t));
    e.O(0, [397, 63, 62, 441, 684, 358], () => t(92402)), (_N_E = e.O());
  },
]);
